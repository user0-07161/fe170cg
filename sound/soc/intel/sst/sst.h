...
static inline void sst_set_gpio_conf(const struct sst_gpio_config *gpio_conf)
{
	...
	//gpio_conf->i2s_rx_alt = 75;
	//gpio_conf->i2s_tx_alt = 74;

	printk("%s: Vic gpio_conf->i2s_rx_alt:%d\n", __FUNCTION__, gpio_conf->i2s_rx_alt);
	printk("%s: Vic gpio_conf->i2s_tx_alt:%d\n", __FUNCTION__, gpio_conf->i2s_tx_alt);
	printk("%s: Vic gpio_conf->i2s_frame:%d\n", __FUNCTION__, gpio_conf->i2s_frame);
	printk("%s: Vic gpio_conf->i2s_clock:%d\n", __FUNCTION__, gpio_conf->i2s_clock);

#if 1
	lnw_gpio_set_alt(75, gpio_conf->alt_function);
	lnw_gpio_set_alt(74, gpio_conf->alt_function);
#else
