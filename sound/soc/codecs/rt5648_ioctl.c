...
hweq_t hweq_param[] = {
	...
	{/* SPK */
        {0},
        {0x1c10, 0x0000, 0x03be, 0xea74, 0x1e38, 0xcf47, 0x1c44, 0x39d9, 0x01c4, 0x0578, 0x0201, 0xaedc, 
        0xef71, 0x1fc9, 0xffa3, 0xce10, 0x1c10, 0x00f2, 0xe904, 0x1c10, 0x0000, 0x0436, 0x0000, 0x1fb4, 0x004b, 0x1fb4,
        0x0800, 0x0800},
        0x004e,
    },
    /*TF103 change value*/
	...
	struct snd_soc_codec *codec, int channel, int mode)
{
	...
	snd_soc_update_bits(codec, upd_reg, RT5648_EQ_UPD, 0x6000);
