...
static struct rt5640_init_reg init_list[] = {
	...
	//{RT5640_ASRC_5		, 0xb69e},//solve weird sound in CSV call due to 16KHz
	{RT5640_ASRC_5		, 0x23d7}, 
#else
...
//	{RT5640_I2S1_SDP	, 0xD000},//change IIS1 and IIS2
	/*record*/
	{RT5640_IN1_IN2		, 0x1000},//IN1 boost 20db and signal ended mode
	{RT5640_IN3_IN4		, 0x0000},//IN2 boost 0db and signal ended mode
	{RT5640_REC_L2_MIXER	, 0x007d},//Mic1 -> RECMIXL
	{RT5640_REC_R2_MIXER	, 0x007f},//Mic1 -> RECMIXR
//	{RT5640_REC_L2_MIXER	, 0x006f},//Mic2 -> RECMIXL
//	{RT5640_REC_R2_MIXER	, 0x006f},//Mic2 -> RECMIXR
	{RT5640_STO_ADC_MIXER	, 0x7440},//DMIC2 -> Strtro ADC Mixer
	{RT5640_MONO_ADC_MIXER	, 0x7454},//DMIC2 -> Mono ADC Mixer
	{RT5640_ADC_DIG_VOL	, 0xafaf},
	{RT5640_MONO_MIXER	, 0xe800},//OUTMIXL -> MONOMIX
#if (CONFIG_SND_SOC_RT5642_MODULE | CONFIG_SND_SOC_RT5642)
...
#endif
#ifdef USE_AGC
	{RT5640_DRC_AGC_1	, 0x2226}, /*MX-B4*/
	{RT5640_DRC_AGC_2	, 0x33b2}, /*MX-B5*/
	{RT5640_DRC_AGC_3	, 0xa557}, /*MX-B6*/
#endif
};
...
int rt5640_headset_detect(struct snd_soc_codec *codec, int jack_insert)
{
	...
	if(jack_insert) {
		...
		//reg80 = snd_soc_read(codec, RT5640_GLB_CLK);
		//reg93 = snd_soc_read(codec, RT5640_MICBIAS);
		//regFA = snd_soc_read(codec, RT5640_GEN_CTRL1);
		...
		snd_soc_update_bits(codec, RT5640_PWR_ANLG2,
			RT5640_PWR_MB1, RT5640_PWR_MB1);
		rt5640_index_update_bits(codec, 0x15, 0x0300, 0x0000);
		...
		for (i = 0 ; i < 20 ; i++) {
			if ((snd_soc_read(codec, RT5640_IRQ_CTRL2) & 0x8)) {
				pr_debug("%d retry with jack\n", i);
				with_jack = true;
				break;
			} else
				pr_debug("%d retry no jack\n", i);
			msleep(50);
		}
		if (!with_jack) {
			pr_debug("%s, No jack detect", __func__);
			jack_type = RT5640_NO_JACK;
			//snd_soc_write(codec, RT5640_PWR_ANLG1, reg63);
			//snd_soc_write(codec, RT5640_PWR_ANLG2, reg64);
		} else {
			rt5640_index_update_bits(codec, 0x15, 0x0300, 0x0200);
			msleep(100);
			if (snd_soc_read(codec, RT5640_IRQ_CTRL2) & 0x8)
		...
		case RT5640_SCLK_S_PLL1:
			sclk_src = RT5640_SCLK_SRC_PLL1;
			break;
		case RT5640_SCLK_S_RCCLK:
			sclk_src = RT5640_SCLK_SRC_RCCLK;
			break;
		case RT5640_SCLK_S_MCLK:
		default:
			sclk_src = RT5640_SCLK_SRC_MCLK;
			break;
		}
		snd_soc_update_bits(codec, RT5640_GLB_CLK,
				RT5640_SCLK_SRC_MASK, sclk_src);
#endif
		//snd_soc_write(codec, RT5640_MICBIAS, reg93);
		
		if (jack_type == RT5640_HEADPHO_DET) {
			pr_debug("%s, insert jack HEADPHONE detect", __func__);
			//snd_soc_write(codec, RT5640_PWR_ANLG1, reg63);
			//snd_soc_write(codec, RT5640_PWR_ANLG2, reg64);
		} else if (jack_type == RT5640_HEADSET_DET) {
			pr_debug("%s, insert jack HEADSET detect", __func__);
			//snd_soc_write(codec, RT5640_PWR_ANLG1, reg63 | RT5640_PWR_LDO2);
			//snd_soc_write(codec, RT5640_PWR_ANLG1, reg63 | RT5640_PWR_LDO2 | RT5640_PWR_VREF1 | RT5640_PWR_MB | RT5640_PWR_BG);
			//snd_soc_write(codec, RT5640_PWR_ANLG2, reg64 | RT5640_PWR_MB1);
		}
		snd_soc_update_bits(codec, RT5640_PWR_ANLG1,
				RT5640_PWR_FV1 | RT5640_PWR_FV2, RT5640_PWR_FV1 | RT5640_PWR_FV2);
	} else {
		pr_debug("%s, remove jack detect", __func__);
		snd_soc_update_bits(codec, RT5640_MICBIAS, RT5640_MIC1_OVCD_MASK, RT5640_MIC1_OVCD_DIS);
		snd_soc_update_bits(codec, RT5640_PWR_ANLG1, RT5640_PWR_LDO2, 0);
		snd_soc_update_bits(codec, RT5640_PWR_ANLG2, RT5640_PWR_MB1, 0);
		if (SND_SOC_BIAS_OFF == codec->dapm.bias_level) {
			snd_soc_update_bits(codec, RT5640_PWR_ANLG1, RT5640_PWR_VREF1, 0);
			snd_soc_update_bits(codec, RT5640_PWR_ANLG1, RT5640_PWR_MB, 0);
			snd_soc_update_bits(codec, RT5640_PWR_ANLG1, RT5640_PWR_BG, 0);
		}
...
static int rt5640_drc_agc_switch_get(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	struct rt5640_priv *rt5640 = snd_soc_codec_get_drvdata(codec);
...
static int rt5640_drc_agc_switch_put(struct snd_kcontrol *kcontrol,
		struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	struct rt5640_priv *rt5640 = snd_soc_codec_get_drvdata(codec);
       int value = 0,reg_value=0x0;
	if(ucontrol->value.integer.value[0])
		reg_value = snd_soc_read(codec, RT5640_DRC_AGC_1) |RT5640_DRC_UPDATE_MASK ;
		else
			reg_value = snd_soc_read(codec, RT5640_DRC_AGC_1) & 0xdfff;
		       snd_soc_write(codec, RT5640_DRC_AGC_1,reg_value);
	return 0;
}
...
static const char * rt5640_drc_agc_mode[] = {"Disable DRC AGC", "Enable DRC to DAC", "Disable DRC AGC", "Enable AGC to ADC"};
static const SOC_ENUM_SINGLE_DECL(
	rt5640_select_drc_agc_enum, RT5640_DRC_AGC_1,
	RT5640_DRC_AGC_SWITCH_SFT, rt5640_drc_agc_mode);


static const char * rt5640_drc_agc_rate_select[] = {"NONE","48K", "96K", "192K", "44.1K","88.2K","176.4K"};
static const SOC_ENUM_SINGLE_DECL(
	rt5640_drc_agc_rate_enum, RT5640_DRC_AGC_1,
	RT5640_DRC_AGC_RATE_SFT, rt5640_drc_agc_rate_select);



static const char * rt5640_drc_agc_update_switch_mode[] = {"Disable", "Enable"};
static const SOC_ENUM_SINGLE_DECL(
	rt5640_update_drc_agc_switch_enum, RT5640_DRC_AGC_1,
	RT5640_DRC_UPDATE_SFT , rt5640_drc_agc_update_switch_mode);


static const char * rt5640_drc_agc_select_rate[] = {"1:1", "1:2","1:4","1:8"};
static const SOC_ENUM_SINGLE_DECL(
	rt5640_drc_agc_select_ratio_enum, RT5640_DRC_AGC_2,
	 RT5640_DRC_AGC_SELECT_RATE_SFT  , rt5640_drc_agc_select_rate);



static const char * rt5640_eq_src_select[] = {"Dac path","Adc path"};
static const SOC_ENUM_SINGLE_DECL(
	rt5640_eq_src_enum, RT5640_EQ_CTRL1,
	RT5640_EQ_SRC_SFT, rt5640_eq_src_select);




static const char * rt5640_eq_para_update_select[] = {"No action","Update parameter"};
static const SOC_ENUM_SINGLE_DECL(
	rt5640_eq_para_update_enum, RT5640_EQ_CTRL1,
	RT5640_EQ_PARA_UPDATE_SFT, rt5640_eq_para_update_select);



static const char * rt5640_eq_hpf_mode_select[] = {"High frequency shelving filter","1st order Butterworth HPF"};
static const SOC_ENUM_SINGLE_DECL(
	rt5640_eq_hpf_mode_ctrl_enum, RT5640_EQ_CTRL2,
	RT5640_EQ_HPF_MODE_CTRL_SFT, rt5640_eq_hpf_mode_select);
...
static const struct snd_kcontrol_new rt5640_snd_controls[] = {
	...
	SOC_DOUBLE_EXT_TLV("Speaker Playback Volume", RT5640_SPK_VOL,
		RT5640_L_VOL_SFT, RT5640_R_VOL_SFT, RT5640_VOL_RSCL_MAX, 0,
	...
	SOC_ENUM("Class D SPK Ratio Control", rt5640_clsd_spk_ratio_enum),
       /*MX-B4H of RT5640_DRC_AGC_1*/
       SOC_ENUM("Sel Drc Agc", rt5640_select_drc_agc_enum),
       SOC_ENUM_EXT("Update Drc Agc Switch", rt5640_update_drc_agc_switch_enum,
				 rt5640_drc_agc_switch_get, rt5640_drc_agc_switch_put),
       SOC_SINGLE_TLV("Drc Agc Attack Select", RT5640_DRC_AGC_1,
		RT5640_DRC_AGC_ATTACK_SFT, 16, 0, ctt_tlv),
       SOC_ENUM("Drc Agc Rate Sel", rt5640_drc_agc_rate_enum),
	SOC_SINGLE_TLV("Drc Agc Recovery Rate", RT5640_DRC_AGC_1,
		RT5640_DRC_AGC_RECOVERY_SFT, 16, 0, ctt_tlv),
	/*MX-B5H of RT5640_DRC_AGC_2*/
	/*DRC/AGC Digital Post-Boost Gain (0.375dB/step*/
       SOC_SINGLE_TLV("Drc Agc Post Bst", RT5640_DRC_AGC_2,
		RT5640_DRC_AGC_POST_BST_SFT, RT5640_DRC_AGC_POST_BST_RANGE
		, 0, ctt_tlv),
       /*DRC/AGC Compression Function Control*/
	SOC_SINGLE("En Drc Agc Compress", RT5640_DRC_AGC_2,
				RT5640_EN_DRC_AGC_COMPRESS_SFT, 1, 0),
      /*DRC/AGC Compression Ratio Selection*/
      SOC_ENUM("Sel Ratio", rt5640_drc_agc_select_ratio_enum),
     /*DRC/AGC Digital Pre-Boost Gain (1.5dB/step)*/
     SOC_SINGLE_TLV("Sel_Drc/Agc_Pre_Bst", RT5640_DRC_AGC_2,
		RT5640_DRC_AGC_TO_PREBOOST_SFT,
		RT5640_DRC_AGC_TO_PREBOOST_RANGE
		, 0, btt_tlv),
       /*MX-B6h of RT5640_DRC_AGC_3*/
       /*Select Compensation Gain When Signal is Below Noise Gate*/
	SOC_SINGLE_TLV("Noise Gate Boost", RT5640_DRC_AGC_3,
		RT5640_DRC_AGC_NOISE_GATE_BST_SFT,
		RT5640_DRC_AGC_NOISE_GATE_BST_RANGE , 0, dtt_tlv),
       /*DRC/AGC Limiter Level (1.5dB/step)*/
	SOC_SINGLE_TLV("Sel Drc Agc Thmax", RT5640_DRC_AGC_3,
		RT5640_DRC_AGC_THMAX_SFT,
		RT5640_DRC_AGC_THMAX_RANGE   , 0, btt_tlv),
       /*Enable Noise Gate function*/
       SOC_SINGLE("En Drc Agc Noise Gate", RT5640_DRC_AGC_3,
				 RT5640_EN_DRC_AGC_NOISE_GATE_SFT , 1, 0),
       /*Enable Noise Gate Hold Data Function*/
	 SOC_SINGLE("En Drc Agc Noise Gate Hold", RT5640_DRC_AGC_3,
				 RT5640_EN_DRC_AGC_NOISE_GATE_HOLD_SFT  , 1, 0),
       /*sel_drc_agc_noise_th*/
       SOC_SINGLE_TLV("Sel Drc Agc Noise Th", RT5640_DRC_AGC_3,
		RT5640_DRC_AGC_NOISE_TH_SFT ,
		RT5640_DRC_AGC_NOISE_TH_RANGE , 0, ett_tlv),
	/*MX-B0h EQ ctrl 1*/
	SOC_ENUM("Eq Src Sel", rt5640_eq_src_enum),
	SOC_ENUM("Eq Param Update", rt5640_eq_para_update_enum),
	SOC_SINGLE_TLV("Eq Hpf Band Status", RT5640_EQ_CTRL1,
		RT5640_HPF_BAND_STATUS_SFT, 127, 0, bst_tlv),
	/*MX-B0h EQ ctrl 2*/
       SOC_ENUM("Eq Hpf Mode Ctrl", rt5640_eq_hpf_mode_ctrl_enum),
       SOC_SINGLE("Reg Typ Lpf En", RT5640_EQ_CTRL2,
				 RT5640_EQ_LPF_MODE_CTRL_SFT  , 1, 0),
       SOC_SINGLE("En Hpf2", RT5640_EQ_CTRL2,
				 RT5640_EQ_EN_HPF2_TYPE_SFT  , 1, 0),
       SOC_SINGLE("En Hpf1", RT5640_EQ_CTRL2,
				 RT5640_EQ_EN_HPF1_TYPE_SFT , 1, 0),
      SOC_SINGLE("En Bpf4", RT5640_EQ_CTRL2,
				 RT5640_EQ_EN_BPF4_TYPE_SFT  , 1, 0),
      SOC_SINGLE("En Bpf3", RT5640_EQ_CTRL2,
				 RT5640_EQ_EN_BPF3_TYPE_SFT  , 1, 0),
	SOC_SINGLE("En Bpf2", RT5640_EQ_CTRL2,
				 RT5640_EQ_EN_BPF2_TYPE_SFT  , 1, 0),
       SOC_SINGLE("En Bpf1", RT5640_EQ_CTRL2,
				 RT5640_EQ_EN_BPF1_TYPE_SFT  , 1, 0),
       SOC_SINGLE("En Lpf", RT5640_EQ_CTRL2,
				 RT5640_EQ_EN_LPF_SFT  , 1, 0),
              SOC_SINGLE_TLV("Eq Lpf A1", RT5640_EQ_BW_LOP,          /* EQ Low Pass Filter Coefficient (LPF:a1)  */
		0, 65536, 0, bst_tlv),
              SOC_SINGLE_TLV("Eq Lpf H0", RT5640_EQ_GN_LOP,          /* EQ Low Pass Filter Gain (LPF:H0)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Bpf1 A1",RT5640_EQ_FC_BP1,           /* EQ Band 1 Coefficient (BPF1:a1)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Bpf1 A2", RT5640_EQ_BW_BP1,         /* EQ Band 1 Coefficient (BPF1:a2))  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Bpf1 H0", RT5640_EQ_GN_BP1,          /* EQ Band 1  Gain (BPF1:H0)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Bpf2 A1", RT5640_EQ_FC_BP2,          /* EQ Band 2 Coefficient(BPF2:a1)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Bpf2 A2", RT5640_EQ_BW_BP2,        /*  EQ Band 2 Coefficient(BPF2:a2)   */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Bpf2 H0", RT5640_EQ_GN_BP2,         /* EQ Band 2  Gain (BPF2:H0) */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Bpf3 A1", RT5640_EQ_FC_BP3,         /* EQ Band 3 Coefficient(BPF3:a1)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Bpf3 A2", RT5640_EQ_BW_BP3,        /* EQ Band 3 Coefficient(BPF3:a2)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Bpf3 H0", RT5640_EQ_GN_BP3,         /* EQ Band 3  Gain  (BPF3:H0)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Bpf4 A1", RT5640_EQ_FC_BP4,          /* EQ Band 4 Coefficient(BPF4:a1)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Bpf4 A2", RT5640_EQ_BW_BP4,        /* EQ Band 4 Coefficient(BPF4:a2)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Bpf4 H0", RT5640_EQ_GN_BP4,         /* EQ Band 4  Gain  (BPF4:H0)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Hpf1 A1", RT5640_EQ_FC_HIP1,        /* EQ High Pass Filter 1  Coefficient (HPF1:a1)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Hpf1 H0", RT5640_EQ_GN_HIP1,       /* EQ High Pass Filter 1  Gain (HPF1:H0)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Hpf2 A1", RT5640_EQ_FC_HIP2,       /* EQ High Pass Filter 2  Coefficient (HPF2:a1)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Hpf2 A2", RT5640_EQ_BW_HIP2,     /* EQ High Pass Filter 2  Coefficient (HPF2:a2)  */
		0, 65536, 0, bst_tlv),
		SOC_SINGLE_TLV("Eq Hpf2 H0", RT5640_EQ_GN_HIP2,      /* EQ High Pass Filter 2  Gain (HPF2:H0)  */
		0, 65536, 0, bst_tlv),
	/* DMIC */
...
#ifdef USE_AGC
                pr_debug("%s: enable agc\n",__func__);
		snd_soc_update_bits(codec, RT5640_DRC_AGC_1,
			RT5640_DRC_AGC_MASK | RT5640_DRC_AGC_P_MASK,
			RT5640_DRC_AGC_EN | RT5640_DRC_AGC_P_ADC);
#endif
		break;

	case SND_SOC_DAPM_POST_PMD:
#ifdef USE_AGC
                pr_debug("%s: disable agc\n",__func__);
		snd_soc_update_bits(codec, RT5640_DRC_AGC_1,
			RT5640_DRC_AGC_MASK, RT5640_DRC_AGC_DIS);
#endif
		rt5640_index_update_bits(codec,
...
static int rt5640_class_d_event(struct snd_soc_dapm_widget *w,
		struct snd_kcontrol *kcontrol, int event)
{
	struct snd_soc_codec *codec = w->codec;
	struct rt5640_priv *rt5640 = snd_soc_codec_get_drvdata(codec);
	...
	case SND_SOC_DAPM_POST_PMU:
		if (0x6 > rt5640->v_code)
			mod_timer(&mclk_check_timer, jiffies + (HZ / 2));
		break;
...
#ifdef USE_ASRC
		snd_soc_write(codec, RT5640_ASRC_1, 0x9b00);
...
#ifdef USE_ASRC
		val = snd_soc_read(codec, RT5640_PWR_DIG1);
		if (((val & RT5640_PWR_I2S1) == 0) &&
		    ((val & RT5640_PWR_I2S2) == 0)) {
...
static const struct snd_soc_dapm_widget rt5640_dapm_widgets[] = {
	...
	SND_SOC_DAPM_SUPPLY("Class D", RT5640_PWR_DIG1,
		RT5640_PWR_CLS_D_BIT, 0,
		rt5640_class_d_event,
...
*/
	...
	{"Stereo ADC MIXL", NULL, "ADC clock"},
	...
	{"SPK L amp", NULL, "Class D"},
	{"SPK R amp", NULL, "SPOR MIX"},
	{"SPK R amp", NULL, "Class D"},
			...
			enum snd_soc_bias_level level)
{
	...
	*/
	...
	case SND_SOC_BIAS_STANDBY:
		...
		if (SND_SOC_BIAS_OFF == codec->dapm.bias_level) {
			...
			snd_soc_update_bits(codec, RT5640_PWR_ANLG1,
				...
				RT5640_PWR_FV1 | RT5640_PWR_FV2);
#ifdef USE_ASRC
			snd_soc_write(codec, RT5640_GEN_CTRL1, 0x3771);
#else
	...
	case SND_SOC_BIAS_OFF:
		...
		int reg63 = snd_soc_read(codec, RT5640_PWR_ANLG1);
		int reg64 = snd_soc_read(codec, RT5640_PWR_ANLG2);
		if (headset) {
			pr_debug("reg63=0x%x:\n", reg63);
			pr_debug("reg64=0x%x:\n", reg64);
			snd_soc_write(codec, RT5640_PWR_ANLG1, RT5640_PWR_LDO2 | RT5640_PWR_VREF1 | RT5640_PWR_MB | RT5640_PWR_BG);
...
static int rt5640_probe(struct snd_soc_codec *codec)
{
	...
	pr_debug("read 0x%x=0x%x\n", RT5640_VENDOR_ID, rt5640->v_code);
	...
	// fix rt5640 can't enter suspend mode
	codec->dapm.idle_bias_off = 1;
	rt5640_set_bias_level(codec, SND_SOC_BIAS_OFF);
        // Craig: for pull 5V
        /*
        gpio_5v = get_gpio_by_name("P_+5VSO_EN_10");
        if(gpio_5v > 0){
            if(gpio_request(gpio_5v,"rt5640_probe"))
                pr_debug("Fail to request gpio pin P_+5VSO_EN_10");
            else{
                gpio_direction_output(gpio_5v,1);
                pr_info("pull high P_+5VSO_EN_10:%d\n", gpio_5v);
            }
        } else
            pr_debug("Fail to get gpio pin P_+5VSO_EN_10\n");
        */

	pr_debug("rt5640_probe return 0\n"); //bard
...
static int rt5640_suspend(struct snd_soc_codec *codec, pm_message_t state)
{
	...
	//if (!headset)
	//	if(gpio_5v > 0) gpio_direction_output(gpio_5v,0);
	do_gettimeofday(&end);
        pr_debug("PM-Audio:spent %ld msecs", (end.tv_sec * 1000 + end.tv_usec/1000 - start.tv_sec * 1000 - start.tv_usec/1000));	
	return 0;
}
...
static int rt5640_resume(struct snd_soc_codec *codec)
{
        ...
        do_gettimeofday(&start);
        pr_debug("%s()\n", __func__);
        //if(gpio_5v > 0) gpio_direction_output(gpio_5v,1);
