...
static const struct i2c_board_info asusdec_board_info = {
	I2C_BOARD_INFO("asusdec", 0x1b),
};
#endif
...
static int __init intel_mid_platform_init(void)
{
	...
	printk("@@ set Realtek I2C slave address to 0x1C !!!\n");
	i2c_register_board_info(1, &rt5640_board_info, 1);
	/*Chris porting TF103CG dock ec start*/
#ifdef CONFIG_TF103CG
	i2c_register_board_info(1, &asusdec_board_info, 1);
#endif
	/*Chris porting TF103CG dock ec end*/
