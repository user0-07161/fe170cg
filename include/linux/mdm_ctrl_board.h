...
#define GPIO_SIM1_CD	"SIM1_AP_CD"
#define GPIO_SIM2_CD	"SIM2_AP_CD"
#else
#define GPIO_SIM1_CD	"SIM1_AP_DET_N"
#define GPIO_SIM2_CD	"SIM2_AP_DET_N"
#endif
#define GPIO_REQ_CDUMP	"AP_REQ_CORE_DUMP"
...
struct mdm_ctrl_cpu_data {
	...
	int		 gpio_cdump;
	char	*gpio_sim1_cd_name;
	int		 gpio_sim1_cd;
	char	*gpio_sim2_cd_name;
	int		 gpio_sim2_cd;
	char	*gpio_req_cdump_name;
	int		 gpio_req_cdump;
