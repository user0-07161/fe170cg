...
#define CUSTOM_IOCTL_REG_SET                    (V4L2_CID_CAMERA_LASTP1 + 26)  //ASUS_BSP++, for calibration
#define CUSTOM_IOCTL_REG_GET                    (V4L2_CID_CAMERA_LASTP1 + 27)  //ASUS_BSP++, for calibration
#define CUSTOM_IOCTL_SPI_GET                    (V4L2_CID_CAMERA_LASTP1 + 28)  //ASUS_BSP++, for calibration
