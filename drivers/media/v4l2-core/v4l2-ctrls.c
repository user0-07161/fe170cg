...
const char *v4l2_ctrl_get_name(u32 id)
{
	...
	case V4L2_CID_EXPOSURE:			return "Exposure";
        case V4L2_CID_EFFECT_AURA:              return "AURA";
        case V4L2_CID_WDR:                      return "WDR";
        case V4L2_CID_GSENSOR:                  return "Gsensor Data";
        case V4L2_CID_HDR:                      return "HDR";
        case V4L2_CID_3A_LOCK_ISP:              return "3A Lock";
        case V4L2_CID_MOVING:                   return "MOVING";
